...
\item Lori Levin, Language Technologies Institute, Carnegie Mellon University, Pittsburgh, PA, USA % APB: is she still around and active? 
...
\item Michal Novak, Charles University, Prague CZ % APB: are we still in contact with him?
\item Lucie Pol\'{a}kov\'{a}, Charles University, Prague CZ % APB: are we still in contact with her?
...
% Yulia Grishina (former PhD student of MAnfred Stede) -> SL: yes
...
% Nikolaos Pappas from Idiap -> SL: yes
% maybe Carol Scarton, former PhD student of Lucia (on QE at discourse level) -> SL: yes
...
% APB: find  the numbers for 2017 (in the proceedings?) and the full reference
...
% APB: I would shorten this quite a lot, add something about WMT 2018 evaluations on pronouns.
% The goal is mostly to explain why we don't do a shared task.
...
https://aclanthology.coli.uni-saarland.de/papers/W18-6435/w18-6435 % the wmt 2018 paper on evaluating on pronouns
